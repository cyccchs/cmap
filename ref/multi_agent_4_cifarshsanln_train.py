...
from multi_agent_4_cifarshsanln_model import RecurrentAttentionModel
...
tf.app.flags.DEFINE_integer("num_steps", 500000, "Number of training steps.")
...
tf.app.flags.DEFINE_integer("num_glimpses", 1, "Number of glimpses.")
