...
class MultiAgentRecurrentAttention(nn.Module):
    ...
    def forward(self, img):
        ...
        for i in range(self.glimpse_num):
            h_t, c_t, prob, l_t, b_t, log_pi_t, log_prob, alpha_list_t, last = self.ram_loop(img, h_prev, c_prev, l_prev, i)
        ...
        return  log_probs, prob_ts, terminate_ts, T_reward, l_list, b_list, log_pi_list, alpha_list, g_num
